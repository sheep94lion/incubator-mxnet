...
void PrintOutputResult(const std::vector<float>& data, const std::vector<std::string>& synset) {
    ...
    printf("Best Result: %s (id=%d, accuracy=%.8f)", trim(synset[best_idx]).c_str(), best_idx, best_accuracy);
}
...
int main() {
    ...
    // std::string json_file = "/home/yizhao/Code/saved_model/resnet18/resnet-18-symbol.json";
    std::string json_file = "/home/yizhao/Code/saved_model/resnet18/partial_resnet18.json";
    std::string param_file = "/home/yizhao/Code/saved_model/resnet18/resnet-18-0000.params";
    std::string synset_file = "/home/yizhao/Code/saved_model/resnet18/synset.txt";
    ...
    // LOGI("Length of resnet-18-symbol.json: %d", json_data.GetLength());
    PredictorHandle pred_hnd;
    printf("Pointer pred_hnd: %x\n", pred_hnd);
